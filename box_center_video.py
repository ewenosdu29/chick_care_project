...
def box_center_video(rgb_path, therm_path, model_path):
    ...
    cap_therm = cv2.VideoCapture(therm_path)
...
# model_path = "D:/ISEN/M1/ProjetM1/chick_care_v2_eh_lp/runs/detect/train2/weights/best.pt"
...
# box_center_video(rgb_video_path, therm_video_path, model_path)